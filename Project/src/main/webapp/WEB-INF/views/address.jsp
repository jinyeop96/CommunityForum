...
<body>
    ...
    <div class="container d-flex align-items-center flex-column">
		...
		<table style="width: 100%">
			<tr>
				<td>
					<c:if test="${empty address }"><input id="searchLoc"><input type="button" id="search" onclick="search()" value="검색"></c:if>
					<c:if test="${!empty address }"><input id="searchLoc" value="${address }"><input id="search" type="button" onclick="search()" value="검색"></c:if>
	    		</td>
			</tr>
		</table>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=86b59d080c4ee3e8f0d9fc3cfd7b71c8&libraries=services,clusterer"></script>
	<script>
