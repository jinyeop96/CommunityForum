     	...
     	<section class="box_instruc_con">
     		...
     		<!-- 		<div class="box_btn">
     				...
     				<div class=="floatL w55per marB20 re100">
     					...
     					<div class="line marB20"></div>
     					<div class="box_btn">
     						<a class="btn_down white" src="<c:url value='/resources/img/logos/OWY-2.png'/>" target="_blank" title="표준규격 다운로드">표준규격 다운로드</a>
     					</div>
     				</div>
     				<br><br><br>
     				...
     				<div class=="floatL w55per marB20 re100">
     					...
     					<div class="line marB20"></div>
     					<div class="box_btn">
     						<a class="btn_down white" src="<c:url value='/resources/img/logos/OWY-3.png'/>" target="_blank" title="표준규격 다운로드">표준규격 다운로드</a>
     					</div>
     				</div>
     				<br><br><br>
     				...
     				<div class=="floatL w55per marB20 re100">
     					...
     					<div class="line marB20"></div>
     					<div class="box_btn">
     						<a class="btn_down white" src="<c:url value='/resources/img/logos/OWY-4.png'/>" target="_blank" title="표준규격 다운로드">표준규격 다운로드</a>
     					</div>
     				</div><br><br>
