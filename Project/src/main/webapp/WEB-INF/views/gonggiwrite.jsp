    ...
    <div class="container d-flex align-items-center flex-column">
      ...
      <div id="qnaDiv" align="center">
      	...
      	<h1 style = " font-size:20px; margin-top:20px;" align="center" ></h1>
      		...
      		<!-- qna 리스트 출력 -->
      		<form method="post" action="/gonggiwritePost.do">
      		<!-- <div class="row">
      			<div class="col-lg-12">
     ...
     <div style="margin: auto;  height: 70px; margin-top: 20px; width: 900px;" >
  		<input type="text" class="form-control" id="title" name="title" placeholder="제목을 입력해주세요" style="width: 100%; height: 50px; position: relative;" required>
	</div>
   	<div style="margin: auto;  height: 370px; margin-top: 10px; width: 900px; " >
   		<textarea id="content" name="content" style="width: 100%; height: 100%;" placeholder="내용을 작성해주세요" required></textarea>
   	</div>
